...
const DOWNLOAD_MANAGER_URL = "chrome://suitedlmgrui/content/downloads/downloadmanager.xul";
...
nsDownloadManagerUI.prototype = {
  classDescription: "Used to show the Download Manager's Tree UI to the user",
  classID: Components.ID("7e77a941-d4b9-406a-a657-78554589e101"),
